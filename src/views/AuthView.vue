  ...
  <div class="flex h-screen flex-col items-center bg-white pt-20">
    ...
    <div class="flex h-fit w-75 flex-col rounded-sm border border-gray-300 p-5">
      ...
      <form @submit.prevent="signIn">
        ...
        <input
          type="email"
          class="mb-2.5 w-full rounded-md border border-gray-400 bg-white p-2 text-sm outline-none focus:ring-2 focus:ring-yellow-500"
          v-model="email"
        />
        ...
        <button
          type="submit"
          class="mt-2.5 w-full rounded-full bg-yellow-300 py-2 text-sm font-medium"
        >
          Sign In
        </button>
      </form>
      ...
      <button
        ...
        class="mt-2.5 w-full rounded-full border border-gray-300 bg-gray-200 py-2 text-sm font-medium"
      >
